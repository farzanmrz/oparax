...
docs/                   roadmap.md (the plan), onboarding-algorithm.md (the algorithm), source-table-seed.json (the shared table's seed), exp1.md (experiment), setup.md (external setup), findings.md, reshad.md, people.tsv (discovery)
