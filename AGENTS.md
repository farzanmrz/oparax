...
- **Frontend test login:** No dedicated test account is currently configured. The previous dummy account was removed. Owner-requested browser login remains pre-authorized; do not assume a replacement test identity exists.
