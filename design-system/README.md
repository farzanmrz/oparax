...
- `tokens.css`: fonts (Nunito Sans headings, Source Sans 3 text, JetBrains Mono for handles and counts), radius, the light and dark color slots.
- `previews/colors.html`, `type.html`, `buttons.html`, `badges.html`, `inputs.html`, `card.html`, `header.html`: one card each in the Design System pane.
