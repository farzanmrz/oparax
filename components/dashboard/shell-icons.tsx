...
export function InsightsIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      ...
      />
      <path
        d="M7.5 14.6l3-3.3 2.6 2.2 4.4-5.1"
        stroke="currentColor"
        strokeWidth="1.9"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function ProfileIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      ...
      <path
        d="M5.5 19.6a6.5 6.5 0 0 1 13 0"
        stroke="currentColor"
        strokeWidth="1.9"
        strokeLinecap="round"
      />
...
export function SignOutIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <path
        d="M14.5 7.5V5.6A1.6 1.6 0 0 0 12.9 4H6.6A1.6 1.6 0 0 0 5 5.6v12.8A1.6 1.6 0 0 0 6.6 20h6.3a1.6 1.6 0 0 0 1.6-1.6V16.5"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function GearIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <path
        d="M19.4 13c.04-.32.06-.66.06-1s-.02-.68-.07-1l2.11-1.63a.5.5 0 0 0 .12-.64l-2-3.46a.5.5 0 0 0-.61-.22l-2.49 1a7.3 7.3 0 0 0-1.73-1l-.38-2.65A.49.49 0 0 0 13.93 2h-4a.49.49 0 0 0-.49.42l-.38 2.65a7.3 7.3 0 0 0-1.73 1l-2.49-1a.5.5 0 0 0-.61.22l-2 3.46a.5.5 0 0 0 .12.64L4.07 11c-.05.32-.07.66-.07 1s.02.68.07 1l-2.11 1.63a.5.5 0 0 0-.12.64l2 3.46a.5.5 0 0 0 .61.22l2.49-1c.53.4 1.11.74 1.73 1l.38 2.65c.04.24.25.42.49.42h4c.24 0 .45-.18.49-.42l.38-2.65c.62-.26 1.2-.6 1.73-1l2.49 1a.5.5 0 0 0 .61-.22l2-3.46a.5.5 0 0 0-.12-.64z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinejoin="round"
      />
...
export function LinkIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <path
        d="M9.5 14.5a3.4 3.4 0 0 0 4.8 0l3-3a3.4 3.4 0 0 0-4.8-4.8l-1.3 1.3"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
      <path
        d="M14.5 9.5a3.4 3.4 0 0 0-4.8 0l-3 3a3.4 3.4 0 0 0 4.8 4.8l1.3-1.3"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
...
export function BellIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <path
        d="M18 16.5V11a6 6 0 0 0-12 0v5.5L4.2 18.4h15.6z"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinejoin="round"
      />
...
export function ShieldIcon(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <path
        d="M12 3.3 19 6v5.4c0 4.4-3 7.6-7 9.3-4-1.7-7-4.9-7-9.3V6z"
        stroke="currentColor"
        strokeWidth="1.7"
        strokeLinejoin="round"
      />
...
export function LinkedInTile(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      ...
      <path
        fill="#ffffff"
        d="M10.8 10.3h2.3v.96h.03c.34-.6 1.18-1.18 2.42-1.18 2.55 0 3.02 1.56 3.02 3.66v3.56h-2.4v-3.16c0-.78-.02-1.78-1.12-1.78-1.12 0-1.29.85-1.29 1.72v3.22h-2.4Z"
      />
    </svg>
  );
}
    ...
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      ...
      <g transform="translate(6 6) scale(0.5)">
        <path
          ...
          fill="#25F4EE"
          d="M16.6 3h-2.7v11.6a2.3 2.3 0 1 1-2.3-2.3c.2 0 .4 0 .6.05V9.6a5.2 5.2 0 1 0 4.4 5.1V8.85a6.3 6.3 0 0 0 3.6 1.15V7.3a3.6 3.6 0 0 1-3.3-3.5Z"
        />
        <path
          transform="translate(1.1 -0.2)"
          fill="#FE2C55"
...
export function FacebookTile(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      ...
      <path
        fill="#ffffff"
        d="M14.3 19.6v-5.5h1.85l.35-2.27h-2.2v-1.45c0-.62.22-1.05 1.1-1.05h1.18V7.3a14.8 14.8 0 0 0-1.78-.1c-1.78 0-3 1.08-3 3.07v1.66H9.7v2.27h1.85v5.5Z"
      />
    </svg>
  );
}
...
export function MastodonTile(props: IconProps) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      ...
      <path
        fill="#ffffff"
        d="M17.9 9.55c0-2.7-1.77-3.5-1.77-3.5-.9-.41-2.43-.59-4.05-.6h-.04c-1.62.01-3.16.19-4.05.6 0 0-1.77.8-1.77 3.5 0 .62-.01 1.36.01 2.15.06 2.65.48 5.27 2.93 5.92 1.15.3 2.13.37 2.92.32 1.28-.07 2-.46 2-.46l-.04-.93s-.92.29-1.95.26c-1.02-.04-2.1-.11-2.27-1.36a2.5 2.5 0 0 1-.02-.35s1 .24 2.28.3c.78.04 1.51-.05 2.26-.13 1.42-.17 2.66-1.06 2.82-1.86.25-1.27.23-3.1.23-3.1Zm-2.16 3.58h-1.34v-3.28c0-.69-.29-1.04-.88-1.04-.64 0-.97.42-.97 1.24v1.8h-1.33v-1.8c0-.82-.33-1.24-.97-1.24-.58 0-.87.35-.87 1.04v3.28H8.06V9.65c0-.69.18-1.24.53-1.64.36-.4.84-.61 1.44-.61.69 0 1.21.27 1.55.8l.33.56.34-.56c.34-.53.86-.8 1.55-.8.6 0 1.08.21 1.44.61.35.4.53.95.53 1.64Z"
      />
    </svg>
  );
}
