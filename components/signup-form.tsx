...
const ssoButtonClass =
  "h-11 border-border/80 bg-background/70 text-foreground shadow-sm hover:-translate-y-px hover:border-teal-500/45 hover:bg-teal-500/10 hover:text-foreground hover:shadow-md active:translate-y-0 active:scale-[0.99] active:bg-teal-500/15 active:shadow-inner"
    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden border-border/70 bg-card/95 p-0 shadow-2xl shadow-foreground/10 md:h-[700px]">
        <CardContent className="grid h-full p-0 md:grid-cols-2">
          <form action={signup} className="flex h-full flex-col justify-center bg-gradient-to-b from-card to-muted/30 p-6 md:p-8">
            <FieldGroup className="gap-4">
              ...
              <Field className="flex flex-col gap-3">
                <Button variant="outline" type="button" className={cn("w-full", ssoButtonClass)}>
