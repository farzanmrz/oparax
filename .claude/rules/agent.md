...
- The day-window start (`yesterday`) is `min(sinceUnix, now−24h)`, so a long scan frequency's coarse day window doesn't clamp the finer since-bound and drop older posts.
