...
#   - schema   : ../qc-findings-schema.json, override with COUNCIL_SCHEMA (the plan
#                phase points it at ../plan-critique-schema.json)
...
SCHEMA="${COUNCIL_SCHEMA:-$HERE/../qc-findings-schema.json}"
