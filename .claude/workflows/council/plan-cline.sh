...
# enabled by default when discovered. Without this the critic is advertised ft-spec,
# ft-ship and ft-fix — an orchestration flow it must not run — and could fire
...
# (ft-find phase 5, ft-spec phase 6 — never this wrapper).
