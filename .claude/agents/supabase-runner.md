...
tools: mcp__supabase__execute_sql, mcp__supabase__apply_migration, mcp__supabase__list_migrations, mcp__supabase__list_tables, mcp__supabase__generate_typescript_types, mcp__supabase__get_advisors, mcp__supabase__query_logs, mcp__supabase__search_docs, Read, Grep, Write
model: sonnet
---
...
- Read-only diagnostics (`get_advisors`, `query_logs`), summarize findings to one line each.
