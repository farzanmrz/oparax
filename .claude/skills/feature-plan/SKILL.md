...
description: >-
  ...
  /feature-plan, or invoke it yourself when a conversation converges on
  buildable functionality. Not for specs, code, or branches: building starts
  later with /feature-spec <N>.
...
3. **`## Decided`**: decisions the owner locked while talking. Binding on
   feature-spec AND readable by the owner. Focused ("Block Kit, iterate in
