...
- **Briefs:** each dispatched task gets `docs/feature/task-<N>-brief.md` (plan text
...
scope goes to the issue's Deferred list or the user's `docs/triage.md`, never onto
the branch. Skill grounding is binding: name the area's `.claude/rules/` skills in
every dispatch.
