...
* **The proof bar:** build passes, app boots, each journey is experienced once end to end. The owner and real users are the deep test. No commissioned test harnesses, suites, benchmarks, or deployment checks unless the owner explicitly orders one.
